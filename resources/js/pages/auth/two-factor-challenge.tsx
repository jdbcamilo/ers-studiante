                    ...
                    {({ errors, processing, clearErrors }) => (
                        <>
                            ...
                            <div className="text-center text-xs text-muted-foreground tracking-wide uppercase">
                                ...
                                <button
                                    type="button"
                                    className="cursor-pointer text-foreground underline decoration-neutral-300 underline-offset-4 transition-colors duration-300 ease-out hover:decoration-current! dark:decoration-neutral-500 font-bold"
                                    onClick={() =>
